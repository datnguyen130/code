...
<body>
	<div id="background">
		<div id="page">
			<div id="header">
				<div id="logo">
					<a href="index.html"><img src="{{URL::asset('images/logo.png')}}" alt="LOGO" height="112" width="118"></a>
				</div>
				<div id="navigation">
					<ul>
						<li class="selected">
			...
			<div id="contents">
				<div id="adbox">
					<img src="{{URL::asset('images/sea-sound.jpg')}}" alt="Img">
				...
				<div id="sidebar">
					<div class="section">
						<a href="rooms.html"><img src="{{URL::asset('images/rooms.png')}}" alt="Img"></a>
					</div>
					<div class="section">
						<a href="dives.html"><img src="{{URL::asset('images/dive-site.png')}}" alt="Img"></a>
					</div>
					<div class="section">
						<a href="foods.html"><img src="{{URL::asset('images/food.png')}}" alt="Img"></a>
					</div>
				</div>
			</div>
		</div>
