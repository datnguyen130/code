...
<header class="header-section">
    <div class="header-top">
        <div class="container">
            ...
            <div class="ht-right">
                <a href="../../../../../../down/login.html" class="login-panel"><i class="fa fa-user"></i>Login</a>
                <div class="lan-selector">
                    <select class="language_drop" name="countries" id="countries" style="width:300px;">
                        <option value='yt' data-image="front/front/img/flag-1.jpg" data-imagecss="flag yt"
                        ...
                        <li class="cart-icon">
                            ...
                            <div class="cart-hover">
                                ...
                                <div class="select-button">
                                    <a href="../../../../../../down/shopping-cart.html" class="primary-btn view-card">VIEW CARD</a>
                                    <a href="../../../../../../down/check-out.html" class="primary-btn checkout-btn">CHECK OUT</a>
                                </div>
                            </div>
                        </li>
        ...
        <div class="container">
            ...
            <nav class="nav-menu mobile-menu">
                <ul>
                    ...
                    <li><a href="#">Pages</a>
                        <ul class="dropdown">
                            <li><a href="../../../../../../down/blog-details.html">Blog Details</a></li>
                            <li><a href="../../../../../../down/shopping-cart.html">Shopping Cart</a></li>
                            <li><a href="../../../../../../down/check-out.html">Checkout</a></li>
                            <li><a href="../../../../../../down/faq.html">Faq</a></li>
                            <li><a href="../../../../../../down/register.html">Register</a></li>
                            <li><a href="../../../../../../down/login.html">Login</a></li>
                        </ul>
                    </li>
                </ul>
            </nav>
