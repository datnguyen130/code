                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="product-pic-zoom">
                                <img class="product-big-img" src="front/img/products/{{$product->product_images[0]->path}}" alt="">
                                <div class="zoom-icon">
                        ...
                        <div class="col-lg-6">
                            <div class="product-details">
                                ...
                                <div class="pd-rating">
                                    ...
                                    <span>{{count($product->product_comments)}}</span>
                                </div>
                                <div class="pd-desc">
                                    <p>{{$product->content}}</p>
                                ...
                                <div class="pd-color">
                                    ...
                                    <div class="pd-color-choose">
                                        @foreach(array_unique(array_column($product->product_details->toArray(),'color')) as $productColor)
                                             <div class="cc-item">
                                ...
                                <ul class="pd-tags">
                                    <li><span>CATEGORIES</span>: {{$product->product_category->name}}</li>
                    ...
                    <div class="product-tab">
                        <div class="tab-item">
                            <ul class="nav" role="tablist">
                                ...
                                <li>
                                    <a data-toggle="tab" href="#tab-3" role="tab">Customer Reviews ({{count($product->product_comments)}})</a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="specification-table">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="p-price">@if($product->discount != null)
                                ...
                                <div class="tab-pane fade" id="tab-3" role="tabpanel">
                                    ...
                                    <div class="customer-review-option">
                                        <h4>{{ count($product->product_comments) }} Comments</h4>
                                        <div class="comment-option">
                                            @foreach($product->product_Comments as $productComment)
                                                <div class="co-item">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="front/img/products/{{$relatedProduct->product_images[0]->path}}" alt="">
