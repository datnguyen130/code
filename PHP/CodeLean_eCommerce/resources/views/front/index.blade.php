                ...
                <div class="col-lg-8 offset-lg-1">
                    ...
                    <div class="product-slider owl-carousel women">
                        ...
                        <div class="product-item item {{$womenProduct->tag}}">
                            <div class="pi-pic">
                                <img src="front/img/products/{{$womenProduct->product_images[0]->path }}" alt="">
                                ...
                                <ul>
                                    ...
                                    <li class="quick-view"><a href="../../../../../../down/product.html">+ Quick View</a></li>
                    ...
                    <div class="product-slider owl-carousel men">
                        @foreach($menProducts as $menProduct)
                            <div class="product-item item {{$menProduct->tag}} ">
                                <div class="pi-pic">
                                    <img src="front/img/products/{{$menProduct->product_images[0]->path }}" alt="">
