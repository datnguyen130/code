...
CREATE TABLE Orders(
    ...
    IdCus int,
    Status int CHECK (Status in (0,1,2,3,4,5)), -- 0: đơn hàng bị hủy, 1: đơn hàng mới tiếp nhận, 2: đơn hàng chờ xử lý, 3: đơn hàng đã đóng gói, 4: đơn hàng đã gửi vận chuyển, 5: đơn hàng đã giao thành công
    Total decimal,
    TimeOrder date,
    Created date,
    Updated date,
...
INSERT INTO Books(IdBook, NameBook, Author, YearPushlish, Category, Price, Qty, Status, Created)
VALUES (105, 'Book_5', 'Author_5', 2003, 'Category_2', 400, 200, 1, CURRENT_DATE());
INSERT INTO Books(IdBook, NameBook, Author, YearPushlish, Category, Price, Qty, Status, Created)
VALUES (106, 'Book_6', 'Author_6', 2004, 'Category_2', 250, 20, 1, CURRENT_DATE());
INSERT INTO Books(IdBook, NameBook, Author, YearPushlish, Category, Price, Qty, Status, Created)
...
INSERT INTO Books(IdBook, NameBook, Author, YearPushlish, Category, Price, Qty, Status, Created)
VALUES (111, 'Book_11', 'Author_8', 2001, 'Category_5', 200, 15, 1, CURRENT_DATE());
INSERT INTO Books(IdBook, NameBook, Author, YearPushlish, Category, Price, Qty, Status, Created)
...
VALUES (1001, 501, 1, 1200, '2020-10-30', CURRENT_DATE());
INSERT INTO Orders(IdOrders, IdCus, Status, Total, TimeOrder, Created)
VALUES (1002, 501, 0, 2000, '2020-10-20', CURRENT_DATE());
INSERT INTO Orders(IdOrders, IdCus, Status, Total, TimeOrder, Created)
VALUES (1003, 501, 2, 1500, '2020-10-25', CURRENT_DATE());
INSERT INTO Orders(IdOrders, IdCus, Status, Total, TimeOrder, Created)
VALUES (1004, 502, 2, 500, '2020-10-28', CURRENT_DATE());
INSERT INTO Orders(IdOrders, IdCus, Status, Total, TimeOrder, Created)
VALUES (1005, 503, 3, 2500, '2020-10-26', CURRENT_DATE());
INSERT INTO Orders(IdOrders, IdCus, Status, Total, TimeOrder, Created)
VALUES (1006, 504, 4, 900, '2020-10-30', CURRENT_DATE());
INSERT INTO Orders(IdOrders, IdCus, Status, Total, TimeOrder, Created)
VALUES (1007, 501, 5, 1500, '2020-9-20', CURRENT_DATE());
INSERT INTO Orders(IdOrders, IdCus, Status, Total, TimeOrder, Created)
VALUES (1008, 502, 5, 2500, '2020-9-10', CURRENT_DATE());

INSERT INTO OrderDetail(IdOrder, IdBook, Qty, Price, Created) VALUES (1001, 101, 2, 180, CURRENT_DATE());
INSERT INTO OrderDetail(IdOrder, IdBook, Qty, Price, Created) VALUES (1001, 102, 1, 150, CURRENT_DATE());
INSERT INTO OrderDetail(IdOrder, IdBook, Qty, Price, Created) VALUES (1001, 103, 1, 250, CURRENT_DATE());
INSERT INTO OrderDetail(IdOrder, IdBook, Qty, Price, Created) VALUES (1008, 104, 1, 220, CURRENT_DATE());
INSERT INTO OrderDetail(IdOrder, IdBook, Qty, Price, Created) VALUES (1002, 105, 1, 300, CURRENT_DATE());
INSERT INTO OrderDetail(IdOrder, IdBook, Qty, Price, Created) VALUES (1003, 106, 2, 150, CURRENT_DATE());
INSERT INTO OrderDetail(IdOrder, IdBook, Qty, Price, Created) VALUES (1004, 107, 2, 180, CURRENT_DATE());
INSERT INTO OrderDetail(IdOrder, IdBook, Qty, Price, Created) VALUES (1005, 108, 2, 180, CURRENT_DATE());
INSERT INTO OrderDetail(IdOrder, IdBook, Qty, Price, Created) VALUES (1006, 101, 4, 180, CURRENT_DATE());
INSERT INTO OrderDetail(IdOrder, IdBook, Qty, Price, Created) VALUES (1007, 102, 2, 180, CURRENT_DATE());
INSERT INTO OrderDetail(IdOrder, IdBook, Qty, Price, Created) VALUES (1008, 101, 2, 180, CURRENT_DATE());
